...
This data package contains the data that powers the chart ["Energy consumption by source"](https://ourworldindata.org/grapher/energy-consumption-by-source-and-country?time=2000..latest&facet=metric&country=~OWID_EUR&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
